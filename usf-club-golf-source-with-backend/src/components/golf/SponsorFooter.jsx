              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://www.instagram.com/golfclubatusf/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center hover:opacity-70 transition-opacity">
                    <img src="https://media.base44.com/images/public/6a0ca64f419d5b9f8c59065c/dada89511_black-and-white-outline-instagram-app-logo-icon-7017516951369307x990iaok2.png" alt="Instagram" className="w-6 h-6 invert opacity-50 hover:opacity-80 transition-opacity" />
                  </a>
                  <a href="https://www.linkedin.com/company/club-golf-at-usf2/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center hover:opacity-70 transition-opacity">
                    <img src="https://media.base44.com/images/public/6a0ca64f419d5b9f8c59065c/1b5c3d1f3_png-clipartlinkedin-logo-png-black-and-white-round-icon-circle-vector-transparent-social-media-symbol6577175-thumbnail.webp" alt="LinkedIn" className="w-6 h-6 invert opacity-50 hover:opacity-80 transition-opacity" />
                  </a>
                </div>
              </div>
            </div>
