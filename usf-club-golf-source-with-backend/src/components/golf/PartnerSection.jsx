...
return ( <section className="bg-fairway py-10 border-b border-gold/10"> <div className="max-w-4xl mx-auto px-6 lg:px-12">
{/* Header */} <div className="flex items-center gap-4 mb-8 justify-center"> <div className="h-px flex-1 max-w-[80px] bg-gold/40" /> <span className="font-mono-data text-gold text-xs tracking-[0.3em] uppercase whitespace-nowrap">Official Partners</span> <div className="h-px flex-1 max-w-[80px] bg-gold/40" /> </div>
...
```
    ...
    >
      ...
      <div className="w-16 h-16 rounded-xl overflow-hidden flex items-center justify-center">
        <img
          src="https://media.base44.com/images/public/6a0ca64f419d5b9f8c59065c/249f71bb0_paradisegolflogo.png"
      ...
      >
        <img
          src="https://media.base44.com/images/public/6a0ca64f419d5b9f8c59065c/dada89511_black-and-white-outline-instagram-app-logo-icon-7017516951369307x990iaok2.png"
          alt="Instagram"
