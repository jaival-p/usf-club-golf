...
const pillars = [
  ...
  },
  {
    ...
    desc: 'Funding regional and national tournament travel so students can compete without financial hardship.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Providing high-quality equipment and apparel that enables student-athletes to perform at their best.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1.5">
