      ...
      <div className="max-w-2xl mx-auto px-6 text-center">
        <motion.div
          ...
          <p className="font-inter text-stroke text-lg leading-relaxed mb-8">
            Thank you for your interest in sponsoring the USF Golf Club Charity Classic. Our sponsorship team will review your submission and follow up with invoice details, logo requirements, and next steps.
          </p>
